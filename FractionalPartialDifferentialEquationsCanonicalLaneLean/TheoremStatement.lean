...
def sourceRepository : String :=
  "fractional-partial-differential-equations-canonical-lane"

def sourceDescription : String :=
  "Fractional Partial Differential Equations Canonical Theorem Closure"
...
def sourceTheoremBoundary : SourceTheoremBoundary :=
  { claimBoundary := "classical source boundary carried by formalization" }
